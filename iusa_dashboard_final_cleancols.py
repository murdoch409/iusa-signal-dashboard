...
st.set_page_config(page_title="IUSA Final CleanCols", layout="wide")
st.title("📈 IUSA Buy/Hold/Sell Signal — Final CleanCols")
...
def fetch_data():
    ...
    # If MultiIndex, flatten and rename with standard OHLCV names
